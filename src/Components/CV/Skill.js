                      ...
                      <div className="skill z-depth-2">
                          ...
                          <div className="skill-content">
                            {/* {proficientSkills} */}
                              ...
                              <span title="materialize" className="devicons devicons-materializecss"></span>
                              <span title="bootstrap" className="devicons devicons-bootstrap"></span>
                              <span title="css 3" className="devicons devicons-css3"></span>
                              <span title="mysql" className="devicons devicons-mysql"></span>
                              <span title="msql server" className="devicons devicons-msql_server"></span>
                              <span title="eclipse" className="devicons devicons-eclipse"></span>
                              <span title="visual studio" className="devicons devicons-visualstudio"></span>
                              <span title="git" className="devicons devicons-git"></span>
                              <span title="github" className="devicons devicons-github"></span>
                  ...
                  <div className="col s12 m12">
                      <div className="skill z-depth-2">
                          ...
                          <div className="skill-content">
                              ...
                              <span title="intellij" className="devicons devicons-intellij"></span>
                              <span title="travis" className="devicons devicons-travis"></span>
                  ...
                  <div className="col s12 m12">
                      <div className="skill z-depth-2">
                          ...
                          <div className="skill-content">
                              ...
                              <span title="react" className="devicons devicons-react"></span>
                              <span title="sass" className="devicons devicons-sass"></span>
                              <span title="less" className="devicons devicons-less"></span>
                              <span title="postgresql" className="devicons devicons-postgresql"></span>
                              <span title="mongodb" className="devicons devicons-mongodb"></span>
